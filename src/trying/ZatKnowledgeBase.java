 ...
 * @author NAYA
 */
public class ZatKnowledgeBase {
    
   //Function  Database for the zat the bot 
    static String[][][] ZatBase(){
       
        String[][][] ZatSmartBase ={ 
                               {{"PREDIECT FUTURE", "PREDICT THE FUTURE"},
                                      {"no, i am not designed that way",
                                       "does anybody done it till date",
                                       "what if i tell you i don't"}},
                              {{"BENNETT CAMPUS", "CAMPUS OF BENNETT UNIVERSITY"},
                                      { "It is lush green campus of 69 acres",
                                        "The campus is quiet big and the construction of the education building has been completed "
                                  +"\n"+"and one buidling of hostel has been completed",
                                       " The campus of bennett university is vast "
                                 +"\n"+" and open for further information check this link http://www.bennett.edu.in/overview-0"}},
                              {{"BENNETT UNIVERSITY WEBSITE", "WEBSITE OF BENNETT UNIVERSITY"},
                                       {"yes, why not http://www.bennett.edu.in/",
                                        "It's my pleasure http://www.bennett.edu.in/",
                                        "Here you go with the website: http://www.bennett.edu.in/ "}},
                              {{"FACULTY OF BENNETT UNIVERSITY", "BENNETT UNIVERSITY FACULTY"},
                                               {"The faculty of bennett university is highly qualified "
                                         +"\n"+ "and all have detailed knowledge of the courses",
                                                "Bennett University has highly qualified faculty "
                                         +"\n"+ "for more information see this link http://www.bennett.edu.in/School-of-Engineering",
                                                "Here at bennett university, all the facutly are from prime universities "
                                          +"\n"+"and are highly educated"}},
                              {{"VC OF BENNETT UNIVERSITY", "VICE CHANCELLAR"},
                                               {"Mr. Yaj Medury set up Bennett university ",
                                                "It's Mr. Yej Medury "
                                              + " click here's know more http://www.bennett.edu.in/dr-yaj-medury?gclid=CMDkk8uBsNMCFdOFaAodJ5oOdw",
                                                 "Mr. Yej Medury"}},
                              {{"DEAN OF BENNETT UNIVERSITY", "BENNETT UNIVERSITY DEAN"},
                                               {"Mr. Suneet Tuli is the dean of Bennett University and prior he was in IIT Delhi",
                                                "Here's what i found http://www.bennett.edu.in/dr-suneet-tuli",
                                                "Mr. Suneet Tuli"}},
                        ...
                        {{"NOT UNDERSTOOD**"},
                        {"I HAVE NO IDEA OF WHAT YOU ARE TALKING ABOUT, WOULD YOU LIKE TO TEACH ME",
                         "I'M NOT SURE IF I UNDERSTAND WHAT YOU ARE TALKING ABOUT. PLEASE TEACH ME",
                     ...
                     "THIS WOULD BE DIFFICULT TO ANSWER."}
                        ...
                        {{"ARE YOU A CHAT ROBOT", "ARE YOU A BOT"},
                        {"YES YOU COULD ME BY THIS NAME."}
                        },

                        {{"DO YOU KNOW ME", "YOU KNOW ME"},
                        ...
                        {{"WHERE IS BENNETT UNIVERSITY", "WHERE IS BENNETT LOCATED"},
                                    {"Plot No 8-11, TechZone 2, Greater Noida, Uttar Pradesh 201310, India",
                                     "Its in UP , near small village KASNA",
                                     "Please visit website :: http://www.bennett.edu.in/"}},
                        {{"WHAT YOU KNOW BENNETT UNIVERSITY", "TELL ME ABOUT BENNETT UNIVERSITY"},   
                                                    {"Bennett University is a private university located in Greater Noida, "
                                                      +"\n"+"Uttar Pradesh in the National Capital Region of India."
                                                      +"\n"+ "The foundation stone for the University was laid by Shri Akhilesh Yadav, Chief Minister, Uttar Pradesh."
                                                      +"\n"+"The foundation batch was from 2016",
                                                     "Bennett univeristy is private university an initiavite of Times of India Group which provides courses "
                                                      +"\n"+"like B.tech and MBA in upcoming years it will provide new courses like BBA ,BA.LLB, Mass communication etc."
                                                      +"\n"+"The foundation batch of Bennett University started from 2016.",
                                                      "Bennett University is a private univeristy situtated in Greater Noida "
                                                      +"\n"+"for further information please refer this link http://www.bennett.edu.in/overview"}},
                        {{"CHROME CLOSED**"},
                                 {"IT'S NOT OPEN",
                                 "NOT ON YOUR TASKBAR",
                        ...
                        {{"CHROME OPEN**"},
                         ...
                         {{"DONT DO**"},
                                 {"OK.",
                                  "I WILL NOT",
                                  "AS YOU WISH BUT IT'S GOOD TO CHANGE IT."}},
                        {{"FILE OPENED**"},
                                 {"OPENING.......",
                                 "HERE YOU GO.....",
                                 "FILE OPENED"}},
                        {{"CHROME FAILED**"},
                                 ...
                                 "SORRY , BUT CHROME CRASHED"}},
                        {{"FILE NOT FOUND**"},
                                 {"FILE NOT FOUND ON THIS PATH.",
                                 "FILE IS MISSING.",
                                 "SOMETHING WENT WRONG."}},
                        {{"FOR LIVING"},
                                {"are you asking me ",
                                 "how do i know ",
                                 "is that a relevant question for me "}},
